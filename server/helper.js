...
import rootReducer from '../src/common/lib/Redux/index';

import defaultRoutes from '../src/common/layouts/DefaultLayout/DefaultLayout.route';
import DefaultLayout from '../src/common/layouts/DefaultLayout/DefaultLayout';
...
const renderFullPage = (indexData, html, preloadedState, routeData = {}) => {
    return `
        ...
        <head>
            ...
            <meta
              name="description"
              content="Web site created by Sarvesh Singh"
            />
